...
<div class="container" style="padding-top:15px;">
    <ul class="nav nav-pills newsandbulletins">
        ...
        <li class="border"><a data-toggle="tab" href="#aboutus" class="active show">About Us</b></a></li>
        <li class="border"><a data-toggle="tab" href="#visionandmission" class="nav-link">Vision and Mission</b></a></li>
        <li class="border"><a data-toggle="tab" href="#qualitypolicy" class="nav-link">Quality Policy</b></a></li>
        <li class="border"><a data-toggle="tab" href="#corevalues" class="">Core Values</b></a></li>
        <li class="border"><a data-toggle="tab" href="#accreditions" class="">Accreditations </b></a></li>
        <li class="border"><a data-toggle="tab" href="#achievements" class="nav-link">Achievements</b></a></li>
    </ul>
    <div class="tab-content" >
    <!-- aboutus -->
		  <div id="aboutus" class="tab-pane fade show active box">
		  <section id="about-us">
      ...
      <!-- end of aboutus -->
      <!-- vision and mission -->
	    <div id="visionandmission" class="tab-pane fade box">
      ...
      <!-- end of corevalues -->
      <!-- accreditions -->
      <div id="accreditions" class="tab-pane fade box">
              <div class="box card-header">
                <a class="btn btn-link blue-clr bold btn-block text-left" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo ROOT_URL .  '/aboutus/assets/Conferment of Autonomous Status.pdf'; ?>">
                  Autonomous Status
                </a>
              </div>
              <div class="box card-header">
              ...
              <div class= "box card-header">
              <a class="btn btn-link blue-clr bold btn-block text-left" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo ROOT_URL .  '/aboutus/assets/NBA_CSE_2021-24.pdf'; ?>">
                NBA Accreditation – CSE Department
              </a>
            </div>
            <div class= "box card-header">
              <a class="btn btn-link blue-clr bold btn-block text-left" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo ROOT_URL .  '/aboutus/assets/IT_NBA_Accredition_Approval_2021-2024.pdf'; ?>">
            ...
            <div class="box card-header">
              <a class="btn btn-link blue-clr bold btn-block text-left" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo ROOT_URL .  '/aboutus/assets/EOA Report_21-22 .pdf'; ?>">
                AICTE Recognition
              </a>
            </div>
            <div class="box card-header">
            ...
            <div id="achievements" class="tab-pane fade box">
              <?php
                    /*Fetching JSON file content using php file_get_contents method*/
                        $str_d = file_get_contents("achievements.json");
                    ...
                    for($i = 0; $i < sizeof($d["Achievements"]); $i++)
                    {
                        $temp1 .= "<tr style='text-align:justify;font-size:100%;font-family:verdana;'>";
                        $temp1 .= "<td>" . $d["Achievements"][$i]["id"] . "</td>";
                        $temp1 .= "<td style='white-space:nowrap'>" . $d["Achievements"][$i]["Year(s)"] . "</td>";
                        $temp1 .= "<td>" . $d["Achievements"][$i]["Details"] . "</td>";
                        $temp1 .= "</tr>";
                    }
