...
<div class="container">
    <ul class="nav nav-pills newsandbulletins">
        ...
        <li class="border"><a data-toggle="tab" href="#visionandmission" class="">Vision and Mission</b></a></li>
        <li class="border"><a data-toggle="tab" href="#qualitypolicy" class="active show">Quality Policy</b></a></li>
    ...
    <!-- aboutus -->
      ...
      <!-- qualitypolicy -->		  
      <div id="qualitypolicy" class="tab-pane fade show active box">
